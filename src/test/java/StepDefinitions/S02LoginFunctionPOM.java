...
public class S02LoginFunctionPOM {
    private final SauceDemoLoginPage loginPage = new SauceDemoLoginPage(Hooks.driver.get());
    private final SauceDemoInventoryPage inventoryPage = new SauceDemoInventoryPage(Hooks.driver.get());
    @Given("I am on the login page")
    public void i_am_on_the_login_page() {
       Hooks.driver.get().get("https://www.saucedemo.com/");
    }
